...
//     data['gender'] = this.gender;
//     data['vaccine_card_number'] = this.vaccineCardNumber;
//     data['has_specail_case'] = this.hasSpecailCase;
//     data['birth_certificate_number'] = this.birthCertificateNumber;
//     data['birth_certificate_type'] = this.birthCertificateType;
//     data['birth_certifiacte_image'] = this.birthCertifiacteImage;
//     data['nationalities_id'] = this.nationalitiesId;
//     data['fathers_id'] = this.fathersId;
//     data['mothers_id'] = this.mothersId;
//     data['created_at'] = this.createdAt;
//     data['updated_at'] = this.updatedAt;
//     data['countries_id'] = this.countriesId;
//     data['foreing_birth_country_id'] = this.foreingBirthCountryId;
//     data['health_centers_id'] = this.healthCentersId;
//     return data;
//   }
